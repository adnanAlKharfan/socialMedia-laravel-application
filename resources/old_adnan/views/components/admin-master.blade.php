   ...
   @include('admin.partial._navbar')
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          ...
          <span>mange post</span>
        </a>
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">manage post:</h6>
            <a class="collapse-item" href="{{route('create_post')}}">create a post</a>
            <a class="collapse-item" href="{{route('all_post')}}">all posts</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTw" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('all_user')}}">all user</a>
          </div>
        </div>
      </li>
      @endif
